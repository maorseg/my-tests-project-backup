...
public class InstallAppFromGooglePlayStore {
    ...
    final String testAppPackage = "";
    final String testAppActivity = "com.google.android.finsky.activities.MainActivity";

    @BeforeClass
    public void setUp() throws Exception {

        DesiredCapabilities capabilities = DesiredCapabilities.android();
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "G Flex");
